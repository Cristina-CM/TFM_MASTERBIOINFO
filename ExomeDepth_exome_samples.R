...
# Bed file attach
Bedfile <-file.path("/home/Agilent_SureSelect_allExons_V6.bed")
...
my.ref.samples<-c("X18NR8989_recReadx.bam","X18NR8985_recReadx.bam", "X18NR8983_recReadx.bam", "X18NR8886_recReadx.bam", "X18NR8823_recReadx.bam", "X18NR8755_recReadx.bam", "X18NR8643_recReadx.bam", "X18NR8510_recReadx.bam", "X18NR8444_recReadx.bam", "X18NR8401_recReadx.bam", "X18NR8986_recReadx.bam", "X18NR8881_recReadx.bam", "X18NR8689_recReadx.bam", "X18NR8663_recReadx.bam", "X18NR8595_recReadx.bam", "X18NR8596_recReadx.bam", "X18NR8539_recReadx.bam", "X18NR8535_recReadx.bam", "X18NR8505_recReadx.bam", "X18NR8462_recReadx.bam")
...
for(i in 1:Muestras_nsamples){
  ...
  #imprimir un archivo de salida de CNVs encontradas
  if(nrow(all.exons_CNVs@CNV.calls)>0){
    output.file<-paste0('Muestra_', i,".cnv.txt")
    write.table(file=file.path("/home/output/output_exomas/exomedepth_output",output.file),x=all.exons_CNVs@CNV.calls,row.names=FALSE,quote=F,sep="\t")
}
}
